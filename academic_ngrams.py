...
class Academic:
    ...
    def compute_ngrams(self, pickle_filename_bigrams='academic_bigrams.pkl', pickle_filename_trigrams='academic_trigrams.pkl', pickle_filename_quadgrams='academic_quadgrams.pkl'):
    ...
    def load_ngram_ctrs(self, pickle_filename_bigrams='academic_bigrams.pkl', pickle_filename_trigrams='academic_trigrams.pkl', pickle_filename_quadgrams='academic_quadgrams.pkl'):
